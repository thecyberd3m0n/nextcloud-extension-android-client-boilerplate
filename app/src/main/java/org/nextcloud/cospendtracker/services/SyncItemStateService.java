...
package org.nextcloud.ncextension.services;
...
import org.nextcloud.ncextension.NextcloudExtensionApplication;
...
public class SyncItemStateService extends JobIntentService {
	...
	public void onCreate() {
		((NextcloudExtensionApplication) getApplication()).getAppComponent().injectService(this);
		super.onCreate();
	}

	@Override
	protected void onHandleWork(@NonNull Intent intent) {
		if(mApi.getExtensionsApi() == null) {
